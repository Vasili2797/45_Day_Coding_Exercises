...
public class ArrayExtension {
	...
	public static int[] extendArray(int[] arr) {
		...
		int[] newIntArray = Arrays.copyOf(arr, lengthOfNewArray);
		for (int i = arr.length; i < lengthOfNewArray; i++) {
			newIntArray[i] = arr[i - arr.length] * MULTIPLIER;
		}
		return newIntArray;
	}
